...
public class Fibonacci {
   ...
   public static void main( String[] args ) {
     ...
     // this is just for making the output pretty... no real "fibonacci" functionality
      ...
      BrobInt fibonBrob = new BrobInt( "0" );
      BrobInt oneBehind = new BrobInt( "1" );
      BrobInt twoBehind = new BrobInt( "0" );
      if ( maxCount == 1 ) {
         ...
         for ( int i = 2; i < maxCount; i++ ) {
            fibonBrob = oneBehind.addByte(twoBehind);
            twoBehind = new BrobInt ( oneBehind.toBaseString() );
            oneBehind = new BrobInt ( fibonBrob.toBaseString() );
         }
         System.out.println( "\t" + fibonBrob.toBaseString() );
      }
